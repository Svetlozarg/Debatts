	...
	return (
		<main>
			<div className="col-span-full">
				...
				<h2>Welcome to Debatts!</h2>
				These terms and conditions outline the rules and regulations for
				the use of Debatts Website, located at debatts.com.<br></br>
				<br></br> By accessing this website we assume you accept these
				terms and conditions. Do not continue to use Debatts if you do
				...
				log on this website and compliant to the Debatts&apos;s terms
				and conditions. “Debatts”, “Ourselves”, “We”, “Our” and “Us”,
				refers to the company Debatts. “Party”, “Parties”, or “Us”,
				...
				Debatts&apos;s stated services, in accordance with and subject
				to, prevailing law of the UK. Any use of the above terminology
				...
				<br></br>
				<h2>Cookies</h2>
				We employ the use of cookies. By accessing Debatts, you agreed
				to use cookies in agreement with the Debatts Privacy Policy.
				<br></br>
				<br></br>
				...
				affiliate/advertising partners may also use cookies.<br></br>
				<br></br>
				<h2>License</h2>
				Unless otherwise stated, Debatts Name and/or its licensors own
				the intellectual property rights for all material on Debatts.
				All intellectual property rights are reserved. You may access
				this from Debatts for your own personal use subjected to
				restrictions set in these terms and conditions.<br></br>
				<br></br> You must not:<br></br>
				<br></br>
				<ul className="list-disc ml-8">
					<li>Republish material from Debatts</li>
					<li>Sell, rent or sub-license material from Debatts</li>
					<li>Reproduce, duplicate or copy material from Debatts</li>
					<li>Redistribute content from Debatts</li>
				</ul>
				<br></br>
				...
				Debatts Name does not filter, edit, publish or review Comments
				prior to their presence on the website. Comments do not reflect
				the views and opinions of Debatts Name,its agents and/or
				affiliates. Comments reflect the views and opinions of the
				person who post their views and opinions. To the extent
				permitted by applicable laws, Debatts Name shall not be liable
				...
				<br></br>
				Debatts Name reserves the right to monitor all Comments and to
				remove any Comments which can be considered inappropriate,
				offensive or causes breach of these Terms and Conditions.
				<br></br>
				<br></br> You warrant and represent that: <br></br>
				<br></br>
				<ul className="list-disc ml-8">
					<li>
				...
				<br></br>
				<br></br>
				You hereby grant Debatts Name a non-exclusive license to use,
				...
				<ul className="list-disc ml-8">
					...
					<li>
						and System wide Accredited Businesses except soliciting
				...
				context of the linking party&apos;s site.<br></br>
				<br></br> We may consider and approve other link requests from
				the following types of organizations:<br></br>
				<br></br>
				<ul className="list-disc ml-8">
					<li>
					...
					<li>
						internet portals; accounting, law and consulting firms;
					</li>
					<li>
				...
				of Debatts Name; and (d) the link is in the context of general
				resource information.<br></br>
				<br></br> These organizations may link to our home page so long
				as the link: (a) is not in any way deceptive; (b) does not
				falsely imply sponsorship, endorsement or approval of the
				linking party and its products or services; and (c) fits within
				the context of the linking party&apos;s site.<br></br>
				<br></br> If you are one of the organizations listed in
				paragraph 2 above and are interested in linking to our website,
				you must inform us by sending an e-mail to
				info.debatts@gmail.com. Please include your name, your
				...
				would like to link. Wait 2-3 weeks for a response. <br></br>
				...
				<br></br>
				<br></br>
				No use of Debatts logo or other artwork will be allowed for
				...
				visual presentation or appearance of our Website.<br></br>
				<br></br> <h2> Content Liability</h2> We shall not be hold
				responsible for any content that appears on your Website. You
				agree to protect and defend us against all claims that is rising
				on your Website. No link(s) should appear on any Website that
				may be interpreted as libelous, obscene or criminal, or which
				infringes, otherwise violates, or advocates the infringement or
				other violation of, any third party rights.<br></br>
				<br></br> <h2> Reservation of Rights</h2> We reserve the right
				to request that you remove all links or any particular link to
				our Website. You approve to immediately remove all links to our
				Website upon request. We also reserve the right to amen these
				terms and conditions and it&apos;s linking policy at any time.
				...
				<br></br>We do not ensure that the information on this website
				...
				that the material on the website is kept up to date. <br></br>
				<br></br>
				<h2>Disclaimer</h2>
				<br></br>
				<br></br> To the maximum extent permitted by applicable law, we
				exclude all representations, warranties and conditions relating
				to our website and the use of this website. Nothing in this
				disclaimer will:<br></br>
				<br></br>
				<ul className="list-disc ml-8">
					<li>
				...
				in tort and for breach of statutory duty. <br></br>
				<br></br>As long as the website and the information and services
