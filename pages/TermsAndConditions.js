  ...
  return (
    <main>
      ...
      <div className="col-span-full">
        ...
        of Debatts Website, located at debatts.com.<br></br>
        <br></br> By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Debatts if you do not agree to take
        all of the terms and conditions stated on this page. <br></br>
        ...
        and compliant to the Debatts&apos;s terms and conditions. “Debatts”,
        “Ourselves”, “We”, “Our” and “Us”, refers to the company Debatts.
        ...
        Client&apos;s needs in respect of provision of the Debatts&apos;s stated
        services, in accordance with and subject to, prevailing law of the UK.
        ...
        <br></br>
        <h2>Cookies</h2>
        We employ the use of cookies. By accessing Debatts, you agreed to use
        cookies in agreement with the Debatts Privacy Policy.
        <br></br>
        <br></br>
        ...
        <br></br>
        <h2>License</h2>
        Unless otherwise stated, Debatts Name and/or its licensors own the
        intellectual property rights for all material on Debatts. All
        intellectual property rights are reserved. You may access this from
        Debatts for your own personal use subjected to restrictions set in these
        ...
        information in certain areas of the website. Debatts Name does not
        filter, edit, publish or review Comments prior to their presence on the
        website. Comments do not reflect the views and opinions of Debatts
        ...
        permitted by applicable laws, Debatts Name shall not be liable for the
        ...
        of the Comments on this website.<br></br>
        <br></br>
        Debatts Name reserves the right to monitor all Comments and to remove
        ...
        <br></br>
        <br></br>
        You hereby grant Debatts Name a non-exclusive license to use, reproduce,
        ...
        <br></br>
        <br></br> These organizations may link to our home page, to publications
        ...
        <br></br> We may consider and approve other link requests from the
        following types of organizations:<br></br>
        <br></br>
        <ul className="list-disc ml-8">
          ...
          <li>internet portals; accounting, law and consulting firms;</li>
        ...
        the hyperlink compensates the absence of Debatts Name; and (d) the link
        is in the context of general resource information.<br></br>
        <br></br> These organizations may link to our home page so long as the
        ...
        party&apos;s site.<br></br>
        <br></br> If you are one of the organizations listed in paragraph 2
        above and are interested in linking to our website, you must inform us
        by sending an e-mail to info.debatts@gmail.com. Please include your
        ...
        link. Wait 2-3 weeks for a response. <br></br>
        ...
        <br></br>
        <br></br>
        No use of Debatts logo or other artwork will be allowed for linking
        absent a trademark license agreement.<br></br>
        <br></br>
        <h2>iFrames</h2>
        Without prior approval and written permission, you may not create frames
        around our Webpages that alter in any way the visual presentation or
        appearance of our Website.<br></br>
        <br></br> <h2> Content Liability</h2> We shall not be hold responsible
        ...
        rights.<br></br>
        <br></br> <h2> Reservation of Rights</h2> We reserve the right to
        ...
        <br></br>We do not ensure that the information on this website is
        ...
        material on the website is kept up to date. <br></br>
        <br></br>
        <h2>Disclaimer</h2>
        <br></br>
        <br></br> To the maximum extent permitted by applicable law, we exclude
        all representations, warranties and conditions relating to our website
        and the use of this website. Nothing in this disclaimer will:<br></br>
        <br></br>
        <ul className="list-disc ml-8">
          <li>
        ...
        statutory duty. <br></br>
        <br></br>As long as the website and the information and services on the
