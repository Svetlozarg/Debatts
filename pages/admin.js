    ...
    <main className='max-w-5xl grid-cols-3'>
      ...
      <CardContainer wide hover={false}>
        ...
        <div className='overflow-y-scroll flex justify-start items-stretch flex-col h-full w-full'>
          <table className='table-fixed [&>*>tr:nth-child(odd)]:bg-black/5 [&>*>tr>td:nth-child(2)]:font-mono [&>*>tr>td]:p-0.5 rounded-md  '>
            <tbody>
              <tr>
                <td className='text-left'>Number of posts</td>
                <td className='text-left'>{totalPosts?.length}</td>
              </tr>
              <tr>
                <td className='text-left'>Number of users</td>
                <td className='text-left'>{totalUsers?.length}</td>
              </tr>
              <tr>
                <td className='text-left'>Number of admins</td>
                <td className='text-left'>{totalAdminsUsers?.length}</td>
              </tr>
              <tr>
                <td className='text-left'>Number of banned users</td>
                <td className='text-left'>{totalBannerUsers?.length}</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <CardContainer wide hover={false} className='max-h-[750px]'>
        ...
        <table className='table-auto w-full flex flex-col justify-start items-center  overflow-y-scroll shadow-inner [&>tbody>tr:nth-child(odd)]:bg-black/5'>
          <tbody className='w-full'>
            <tr className='flex flex-row justify-between items-center w-full p-1 px-0'>
              <th>Number</th>
              <th>Username</th>
              <th>Email</th>
              <th>Posts</th>
            ...
            {users
              .slice(
                ...
                Math.min(users.length, (usersPage + 1) * usersPerPage)
              )
              .map((e, i) => {
                return (
                  <tr
