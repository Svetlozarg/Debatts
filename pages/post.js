    ...
    <div className='w-full '>
      ...
      <ul className='list-decimal ml-6'>
        <ul className='list-disc'>
          <li>
            Rule 1: Debatts is a positive community. Do not judge, bully or
            harass those who do not hold the same views as you
          </li>
          <li>
            Rule 2: Where you can, use facts and informed opinions to back up
            your discussion
          </li>
      ...
      <div className='flex flex-row justify-between items-start'>
        ...
        >
          ...
          <div className='w-full absolute left-0 top-[4.5rem] right-0 p-2'>
            <LargeContainer className='max-w-[300px]'>{rules}</LargeContainer>
          </div>
        </div>
        {/* Rules Modal */}
        <Modal
